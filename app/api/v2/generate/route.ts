...
const PRODUCTS: Record<number, string> = {
  ...
  2: "a CIF cleaning product bottle",
  3: "a LUZU TV Shop branded tumbler cup with colorful stickers",
  4: "a Honor smartphone",
};
...
export async function POST(req: NextRequest) {
  try {
    ...
    // 2. Build prompt with product and style
